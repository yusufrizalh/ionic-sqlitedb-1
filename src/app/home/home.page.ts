...
export class HomePage {
  ...
  name_model: string = "";
  row_data: any = [];
  readonly database_name: string = "inixindo_datatable.db";
  readonly table_name: string = "myinixindotable";
  ...
  createDB() {
    this.sqlite
      ...
      .then((db: SQLiteObject) => {
        this.databaseObj = db;
        alert("inixindo_datatable Database Created!");
      })
      .catch((e) => {
...
(pid INTEGER PRIMARY KEY, Name varchar(255))
  ...
  insertRow() {
    ...
    this.databaseObj
      .executeSql(
        `
      INSERT INTO ${this.table_name} (Name)  
VALUES ('${this.name_model}')
    `,
        []
      )
      .then(() => {
